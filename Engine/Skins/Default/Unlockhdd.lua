...
function Render()
	...
	FontDrawText( "Menu", AUTOUPDATE_CHECK1 , XBOX_FONT_CENTER )
	FontPosition( "Menu", 461, 273 )
	FontDrawText( "Menu", AUTOUPDATE_CHECK2 , XBOX_FONT_CENTER )
	FontPosition( "Menu", 461, 293 )
	FontDrawText( "Menu", AUTOUPDATE_CHECK3 , XBOX_FONT_CENTER )
	FontPosition( "Menu", 461, 313 )
	FontDrawText( "Menu", AUTOUPDATE_CHECK4 , XBOX_FONT_CENTER )
