...
#define XBMESH_ALPHAON		   0x10000000
#define XBMESH_XRAY			   0x01000000
...
public:
    ...
    HRESULT Create( CHAR* strFilename, char* szTexture = "" );
	...
	void SetMaterial(D3DCOLORVALUE rgbaDiffuse, D3DCOLORVALUE rgbaAmbient, D3DCOLORVALUE rgbaSpecular, D3DCOLORVALUE rgbaEmissive, float rPower);
	...
	LPDIRECT3DTEXTURE8 GetSubsetTexture(int iWhichSubset = 0);
	void SetSubsetTexture(LPDIRECT3DTEXTURE8 pTexture, int iWhichSubset = 0);
