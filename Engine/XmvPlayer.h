...
public:
    ...
    HRESULT             OpenFile( const CHAR* lpFilename, D3DFORMAT format, BOOL bAllocateTextures  );
    ...
    HRESULT             OpenFileForPackets( const CHAR* lpFilename, D3DFORMAT format, BOOL bAllocateTextures  );
    ...
    HRESULT             OpenMovieFromMemory( const CHAR* lpFilename, D3DFORMAT format, BOOL bAllocateTextures  );
    ...
    // GetTexture returns the most recent frame decoded, for texturing.
...
private:
    ...
    HRESULT             FinishOpeningFile( D3DFORMAT Format, BOOL bAllocateTextures  );
