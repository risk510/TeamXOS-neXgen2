...
/*
#define XC_PC_ESRB_ALL							0x00000000 
#define XC_PC_ESRB_ADULT						0x00000001 
#define XC_PC_ESRB_MATURE						0x00000002  
#define XC_PC_ESRB_TEEN							0x00000003    // Already defined in XBOX.H
#define XC_PC_ESRB_EVERYONE						0x00000004 
#define XC_PC_ESRB_KIDS_TO_ADULTS				0x00000005 
#define XC_PC_ESRB_EARLY_CHILDHOOD				0x00000006 
*/
...
public:
  ...
  char* GetXboxTitleName(char *filename);
  char* GetXboxTitleID(char *filename);
protected:
  XBE_INFO   m_XBEInfo;
  int        m_iHeaderSize;
  char     * m_pHeader;
  ...
  char szTitleImageName[50];
  char szTitleID[255];

} ;

extern CXBE xbeReader;